...
2. Download the [latest release](https://github.com/joseamirandavelez/SignalRGB-Effect-Installer/releases/latest "latest release").
3. Run the executable.
4. Follow the on-screen instructions to begin importing your effects.

## Disclaimer
This project is an independent community tool. The SignalRGB Effect Installer is not affiliated with, authorized, maintained, or endorsed by WhirlwindFX or the official SignalRGB team. Use this tool at your own risk. Always back up your custom effects before performing mass imports.

## Related Projects
Check out RGBJunkie.com for:
- [Interactive Effect Builders](https://rgbjunkie.com/ "Interactive Effect Builders")
- [Custom SignalRGB Scripts](https://rgbjunkie.com/showcase/ "Custom SignalRGB Scripts")
- [Component Builder](https://rgbjunkie.com/builder/ "Component Builder")
- [Effect Combiner](https://rgbjunkie.com/combiner/ "Effect Combiner")
- [Skydimo LUA Builder](https://rgbjunkie.com/skydimo/ "Skydimo LUA Builder")
